...
describe('Webhook', () => {
  ...
  describe('constructor', () => {
    it('should throw an error if the model is null', () => {
      expect(() => new Webhook(null as any)).toThrow('Webhook model cannot be empty');
    });

    it('should create an instance of Webhook', () => {
      const webhook = new Webhook(mockModel);
  ...
  describe('getId', () => {
    ...
    it('should return undefined if the ID is not set', () => {
        ...
        const webhook = new Webhook(modelWithoutId);
  ...
  describe('getNetworkId', () => {
    ...
    it('should return undefined if the network ID is not set', () => {
        ...
        const webhook = new Webhook(modelWithoutNetworkId);
  ...
  describe('getNotificationURI', () => {
    ...
    it('should return undefined if the notification URI is not set', () => {
        ...
        const webhook = new Webhook(modelWithoutNotificationURI);
  ...
  describe('getEventType', () => {
    ...
    it('should return undefined if the event type is not set', () => {
        ...
        const webhook = new Webhook(modelWithoutEventType);
  ...
  describe('getEventFilters', () => {
    it('should return the event filters of the webhook', () => {
        const webhook = new Webhook(mockModel);
        expect(webhook.getEventFilters()).toEqual([{ contract_address: '0x...', from_address: '0x...', to_address: '0x...' }]);
      });
    ...
    const webhook = new Webhook(modelWithoutFilters);
  ...
  describe('list', () => {
    ...
    it('should list all webhooks across multiple pages', async () => {
        Coinbase.apiClients.webhook!.listWebhooks = jest.fn()
